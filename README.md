...
SEOTitle: lsyang的博客 | BY Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: aaaaaaaaa     # 你的github账号
jianshu_username: ssssssssssss  # 你的简书ID。
...
在下面输入的社交账号，没有的添加的不会显示在侧边框中。新加入了[简书](https:/www.jianshu.com)链接, <http://www.jianshu.com/u/username>
